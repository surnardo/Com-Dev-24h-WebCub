<x-form-section submit="updateProfileInformation">
            ...
            <div x-data="{photoName: null, photoPreview: null}" class="col-span-6 sm:col-span-4">
                ...
                <div class="mt-2" x-show="! photoPreview">
                    ...
                    @else
                        ...
                        <img class="h-25 w-25 rounded-full object-cover" src="/storage/profile-photos/user.png" alt="{{ Auth::user()->name }}" /> 
    ...
    <x-slot name="actions">
        ...
        <x-button wire:loading.attr="disabled" wire:target="photo" class="bg-green-600 hover:bg-green-800">
            {{ __('Enregistrer') }}
        </x-button>
    </x-slot>
</x-form-section>
